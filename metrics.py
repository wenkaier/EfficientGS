...
def evaluate(model_paths):
    ...
    for scene_dir in model_paths:
        tmp_fn = osp.join(scene_dir + "/results.json")
        if osp.exists(tmp_fn):
            print("osp.exists:", tmp_fn)
            continue
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                fname_list.sort()
                for fname in tqdm(fname_list, desc="Metric evaluation progress"):
                    image_names.append(fname)
